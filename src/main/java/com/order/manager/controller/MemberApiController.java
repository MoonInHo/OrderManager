...
import static com.order.manager.util.validation.PatternMatcher.*;
...
public class MemberApiController {
    ...
    @PostMapping("/find-id")
    public ResponseEntity<String> requestVerificationCodeToFindUserId(@RequestBody VerificationRequestDto verificationRequestDto, HttpSession session) {
