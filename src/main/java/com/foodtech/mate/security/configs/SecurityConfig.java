...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/", "/sign-out", "view-orders", "/accept-order", "/cancel-order", "/ready-order", "/request-driver-assignment", "/create-delivery-info", "/delivery-driver-assignment", "/delivery-pickup", "/delivery-complete", "/pickup-complete", "/delivery-tracking", "/completed-order-inquiry").hasRole("USER")
