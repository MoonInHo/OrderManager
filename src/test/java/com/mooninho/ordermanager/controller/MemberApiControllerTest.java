//package com.mooninho.ordermanager.controller;
//
//import com.fasterxml.jackson.databind.ObjectMapper;
//import com.mooninho.ordermanager.application.member.application.dto.CreateMemberRequestDto;
//import com.mooninho.ordermanager.application.member.application.service.MemberService;
//import com.mooninho.ordermanager.application.member.domain.entity.Member;
//import com.mooninho.ordermanager.application.member.presentation.MemberRestController;
//import com.mooninho.ordermanager.임시.security.configs.SecurityConfig;
...
//        //given
//        CreateMemberRequestDto accountDto = CreateMemberRequestDto.createAccountDto("test123", "testPassword123!", "김코딩", "010-1234-5678");
...
//
//        //when
//        accountDto.passwordEncrypt(passwordEncoder.encode(account.password()));
//
//        //then
//        assertThat(passwordEncoder.matches(accountDto.getPassword(), account.password()));
//    }
//
//
